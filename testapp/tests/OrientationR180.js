...
class OrientationR180 extends AbstractTest {
    ...
    async testBody(progressCallback) {
        ...
        const status = await Transcode.start()
                ...
                .asset({name: "B", path: R270})
                .asset({name: "C", path: R0})
                .asset({name: "D", path: R90})
            .segment(1000)
                .track({asset: "A"})
            .segment(1000)
...
OrientationR180.displayName = 'OrientationR180';

module.exports = OrientationR180;
